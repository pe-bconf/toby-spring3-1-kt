...
class UserServiceTest {
    ...
    companion object {
        class TestUserService(private val id: String?) : UserService() {
    ...
    fun setUp() {
        this.users = Arrays.asList(
            User("bumjin", "박범진", "p1", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER - 1, 0, null), // 변화없음
            User("joytouch", "강명성", "p2", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER, 0, null), // 변경예상
            User("erwins", "신승한", "p3", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER + 10, MIN_RECOMMEND_FOR_GOLD - 1, null), // 변화없음
            User("madnite1", "이상호", "p4", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER + 10, MIN_RECOMMEND_FOR_GOLD, null), // 변경예상
            User("green ", "오만규", "p5", Level.GOLD, 100, Integer.MAX_VALUE, null) // 변화없음
        )
    }
