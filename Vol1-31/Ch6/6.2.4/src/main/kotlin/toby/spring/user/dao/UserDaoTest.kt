...
class UserDaoTest {
    ...
    @Before
    fun setUp() {
        this.user1 = User("gyumee", "박성철", "springno1", Level.BASIC, 1, 0, null)
        this.user2 = User("leegw700", "이길원", "springno2", Level.SILVER, 55, 10, null)
        this.user3 = User("bumjin", "박범진", "springno3", Level.GOLD, 100, 40, null)
    }
    ...
    fun checkSameUser(target: User, source: User) {
        ...
        assertThat(target.email, `is`(source.email))
    }
