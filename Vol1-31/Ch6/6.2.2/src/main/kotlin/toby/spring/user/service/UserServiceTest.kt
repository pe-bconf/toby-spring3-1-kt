...
class UserServiceTest {
    ...
    fun upgradeLevels() {
        ...
        val mockUserDao = MockUserDao(this.users)
        ...
        val updated = mockUserDao.getUpdated()
        assertThat(updated.size, `is`(2))
        checkLevelUpgraded(updated[0], "joytouch", Level.SILVER)
        checkLevelUpgraded(updated[1], "madnite1", Level.GOLD)
